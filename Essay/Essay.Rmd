---
title: "A comprehensive research of the social factors that affect homelessness in Los Angeles"
...
We have used various statistical methods for examining the fact from different perspectives. We created a summary plot to examine the current circumstances in Los Angeles and used Principal Component Analysis to figure out the reasons why the homelessness is becoming severe in Los Angeles.

# Overview of homeless population in Los Angeles

## Data Collection

First of all, we have used the statistical data given from U.S. Bureau of Labor Statistics[^1], Zillow Group[^2] and California Department of Public Health[^3] to provide a general impression of trend and status quo of the homeless people and sheltered homeless people in Los Angeles. The figure showing this perspective is in the slides page 2 and 3.
