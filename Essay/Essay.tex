...
\hypersetup{unicode=true,
            pdftitle={Essay},
            pdfauthor={Chen Wang, Xinyue Tang},
            pdfborder={0 0 0},
            breaklinks=true}
...
\textbf{\emph{About the authors}}

\emph{Xinyue Tang}: Undergraduate in Computer Science \& Engineering,
Department of Computer Science, University of California, Davis. Email:
\href{mailto:xiytang@ucdavis.edu}{\nolinkurl{xiytang@ucdavis.edu}}

\emph{Chen Wang}: Undergraduate in Computer Engineering, Samueli School
of Engineering, University of California, Irvine. Email:
